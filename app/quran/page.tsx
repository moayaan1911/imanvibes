...
const pageTitle = "Find Solace in the Quran";
const pageDescription =
  "How is your heart feeling today? Select a mood to discover guiding verses.";
    ...
    <div className="page-bg min-h-screen">
      <main className="app-shell">
        ...
        <section className="mt-7">
          <h1 className="max-w-[18rem] text-[3.45rem] leading-[0.92] tracking-[-0.05em] text-[var(--foreground)] [font-family:var(--font-display)]">
